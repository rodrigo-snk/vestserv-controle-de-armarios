...
public class ArmarioComparator implements Comparator<DynamicVO> {
    /**
     ...
     *
     * @param a1 the first armário to be compared.
     * @param a2 the second armário to be compared.
     ...
     */
    @Override
    public int compare(DynamicVO a1, DynamicVO a2) {
